/*
 * Arc4 random number generator for NetBSD.
 * Copyright 1996 David Mazieres <dm@lcs.mit.edu>.
 *
 * Modification and redistribution in source and binary forms is
 * permitted provided that due credit is given to the author and the
 * NetBSD project by leaving this copyright notice intact.
 */
...
/*
 * Modified by Robert Connolly from NetBSD lib/libc/crypt/arc4random.c v1.11.
 * This is arc4random(3) using urandom.
 */

#include "nix-nbsd101-config.h"

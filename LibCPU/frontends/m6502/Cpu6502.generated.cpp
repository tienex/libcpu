...
public:
    ...
    HRESULT STDMETHODCALLTYPE TranslateInstr (CPU_ADDR Pc, ICpuEmitter *pE) override {
        ...
        case 6: {   // adc_imm
            ComPtr<ICpuValue> t0; pE->GetRegister (0, 8, &t0);
            ComPtr<ICpuValue> t1; pE->Cast (CastZExt, t0, 16, &t1);
            ComPtr<ICpuValue> t2; pE->ConstInt (8, m_pCode[Pc + 1], &t2);
            ComPtr<ICpuValue> t3; pE->Cast (CastZExt, t2, 16, &t3);
            ComPtr<ICpuValue> t4; pE->BinaryOp (BinAdd, t1, t3, &t4);
            ComPtr<ICpuValue> t5; pE->GetFlag (FlagCarry, &t5);
            ComPtr<ICpuValue> t6; pE->Cast (CastZExt, t5, 16, &t6);
            ComPtr<ICpuValue> t7; pE->BinaryOp (BinAdd, t4, t6, &t7);
            ComPtr<ICpuValue> t8; pE->Cast (CastTrunc, t7, 8, &t8);
            ComPtr<ICpuValue> t9; pE->ConstInt (16, 0x8, &t9);
            ComPtr<ICpuValue> t10; pE->BinaryOp (BinLShr, t7, t9, &t10);
            ComPtr<ICpuValue> t11; pE->Cast (CastTrunc, t10, 1, &t11);
            pE->SetFlag (FlagCarry, t11);
            ComPtr<ICpuValue> t12; pE->GetRegister (0, 8, &t12);
            ComPtr<ICpuValue> t13; pE->BinaryOp (BinXor, t12, t8, &t13);
            ComPtr<ICpuValue> t14; pE->ConstInt (8, m_pCode[Pc + 1], &t14);
            ComPtr<ICpuValue> t15; pE->BinaryOp (BinXor, t14, t8, &t15);
            ComPtr<ICpuValue> t16; pE->BinaryOp (BinAnd, t13, t15, &t16);
            ComPtr<ICpuValue> t17; pE->ConstInt (8, 0x80, &t17);
            ComPtr<ICpuValue> t18; pE->BinaryOp (BinAnd, t16, t17, &t18);
            ComPtr<ICpuValue> t19; pE->ConstInt (8, 0x0, &t19);
            ComPtr<ICpuValue> t20; pE->Compare (CmpNe, t18, t19, &t20);
            pE->SetFlag (FlagOverflow, t20);
            ComPtr<ICpuValue> t21; pE->ConstInt (8, 0x0, &t21);
            ComPtr<ICpuValue> t22; pE->Compare (CmpEq, t8, t21, &t22);
            pE->SetFlag (FlagZero, t22);
            ComPtr<ICpuValue> t23; pE->ConstInt (8, 0x7, &t23);
            ComPtr<ICpuValue> t24; pE->BinaryOp (BinLShr, t8, t23, &t24);
            ComPtr<ICpuValue> t25; pE->Cast (CastTrunc, t24, 1, &t25);
            pE->SetFlag (FlagNegative, t25);
            ComPtr<ICpuValue> t26; pE->ConstInt (8, 0x4, &t26);
            ComPtr<ICpuValue> t27; pE->BinaryOp (BinLShr, t8, t26, &t27);
            ComPtr<ICpuValue> t28; pE->BinaryOp (BinXor, t8, t27, &t28);
            ComPtr<ICpuValue> t29; pE->ConstInt (8, 0x2, &t29);
            ComPtr<ICpuValue> t30; pE->BinaryOp (BinLShr, t28, t29, &t30);
            ComPtr<ICpuValue> t31; pE->BinaryOp (BinXor, t28, t30, &t31);
            ComPtr<ICpuValue> t32; pE->ConstInt (8, 0x1, &t32);
            ComPtr<ICpuValue> t33; pE->BinaryOp (BinLShr, t31, t32, &t33);
            ComPtr<ICpuValue> t34; pE->BinaryOp (BinXor, t31, t33, &t34);
            ComPtr<ICpuValue> t35; pE->ConstInt (8, 0x1, &t35);
            ComPtr<ICpuValue> t36; pE->BinaryOp (BinAnd, t34, t35, &t36);
            ComPtr<ICpuValue> t37; pE->Cast (CastTrunc, t36, 1, &t37);
            ComPtr<ICpuValue> t38; pE->UnaryOp (UnNot, t37, &t38);
            pE->PutRegister (0, t8, 8, FALSE);
            break;
        }
        case 7: {   // clc

...
class Vga : public IDevice, public IPortDevice, public IDisplayDevice, public IMemoryDevice, public IHostMemory {
public:
    Vga () : m_Ref (1) {}
    ...
    {
        m_Vram.assign (Vga_VramSize, 0);                // the card's own video RAM
        return Reset ();
    }

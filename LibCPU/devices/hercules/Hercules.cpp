...
class Hercules : public IDevice, public IPortDevice, public IDisplayDevice, public IMemoryDevice, public IHostMemory {
public:
    Hercules () : m_Ref (1) {}
    ...
    HRESULT STDMETHODCALLTYPE Configure (IN IDeviceNode *pNode) override
    {
        ...
        m_Base = (UINT16) Base;
        m_Vram.assign (Hgc_VramSize, 0);                // the card's own video RAM
        return Reset ();
    }
